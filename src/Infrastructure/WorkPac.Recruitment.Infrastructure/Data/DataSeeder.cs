...
public class DataSeeder
{
    ...
    public async Task SeedAsync()
    {
        ...
        app1.AddDocument(new DocumentReference
        {
            FileName = "Jack_Harris_Resume.pdf",
            ContentType = "application/pdf",
            SizeBytes = 245_760,
            BlobPath = $"documents/{app1.Id}/resume.pdf"
        });
        app1.AddDocument(new DocumentReference
        {
            FileName = "Certificate_IV_Diesel_Fitting.pdf",
            ContentType = "application/pdf",
            SizeBytes = 184_320,
            BlobPath = $"documents/{app1.Id}/cert4.pdf"
        });
        ...
        app2.AddDocument(new DocumentReference
        {
            FileName = "Sarah_Chen_CV.docx",
            ContentType = "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
            SizeBytes = 192_512,
            BlobPath = $"documents/{app2.Id}/cv.docx"
        });
        ...
        app3.AddDocument(new DocumentReference
        {
            FileName = "Jake_Thompson_Resume.pdf",
            ContentType = "application/pdf",
            SizeBytes = 159_744,
            BlobPath = $"documents/{app3.Id}/resume.pdf"
        });
        app3.AddDocument(new DocumentReference
        {
            FileName = "Shotfirer_Licence.jpg",
            ContentType = "image/jpeg",
            SizeBytes = 88_064,
            BlobPath = $"documents/{app3.Id}/licence.jpg"
        });
